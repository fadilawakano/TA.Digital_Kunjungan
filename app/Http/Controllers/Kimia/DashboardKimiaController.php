    ...
    public function index()
{
    ...
    return view('kimia.dashboard', [
        'muridHariIni' => Kunjungan::where('role_tujuan', 'kimia')
            ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
            ->whereHas('user', fn ($q) => $q->where('role', 'murid'))
            ->count(),

        'guruHariIni' => Kunjungan::where('role_tujuan', 'kimia')
            ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
            ->whereHas('user', fn ($q) => $q->where('role', 'guru'))
            ->count(),

        'statusVerifikasi' => [
            'murid_berhasil' => Kunjungan::where('role_tujuan', 'kimia')
                ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
                ->whereHas('user', fn ($q) => $q->where('role', 'murid'))
            ...
            'murid_rusak' => Kunjungan::where('role_tujuan', 'kimia')
                ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
                ->whereHas('user', fn ($q) => $q->where('role', 'murid'))
                ->whereNotNull('verifikasi_petugas')
            ...
            'guru_berhasil' => Kunjungan::where('role_tujuan', 'kimia')
                ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
                ->whereHas('user', fn ($q) => $q->where('role', 'guru'))
                ->whereNotNull('verifikasi_petugas')
                ->where('status_verifikasi', 'berhasil')
            ...
            'guru_rusak' => Kunjungan::where('role_tujuan', 'kimia')
                ->whereBetween('tanggal', [$startOfMonth, $endOfMonth])
                ->whereHas('user', fn ($q) => $q->where('role', 'guru'))
                ->whereNotNull('verifikasi_petugas')
                ->where('status_verifikasi', 'kerusakan')
