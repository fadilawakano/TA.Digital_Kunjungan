...
<div class="p-6"
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
            <form action="{{ route('biologi.filter', 'guru') }}" method="GET" class="flex flex-wrap items-center gap-2">
                ...
                <a 
                    :href="`{{ route('biologi.cetak.biologi.guru') }}?filter_jenis=${filterJenis}` +
