...
<div class="container mx-auto px-4 py-6">
    <h3 class="text-xl font-bold mb-4">Data Kunjungan Laboratorium Kimia</h3>
    ...
    <table class="min-w-full bg-white shadow-md rounded border">
        ...
        <tbody>
            @foreach ($kunjunganKimia as $kunjungan)
                <tr>
                    ...
                    <td class="p-2 border">
                        @if (!$kunjungan->status_verifikasi)
                            <form method="POST" action="{{ route('kimia.verifikasi', $kunjungan->id) }}">
                                @csrf
